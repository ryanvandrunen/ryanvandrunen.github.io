  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        hero: 'linear-gradient(135deg, rgba(244,244,246,.8) 60%,rgba(244,244,246,.8) 60%)',
        'hero-mobile':
          'linear-gradient(135deg, rgba(244,244,246,.8) 60%,rgba(244,244,246,.8) 60%)',
        tech: "linear-gradient(165deg, rgba(20,20,20,0.8) 100%, rgba(109,109,116,0.8) 100%), url('/src/assets/backgrounds/nairobi.png')",
        orange: "linear-gradient(180deg,#f59542 0%,rgba(255, 255,255,0) 100%)"
      },
      fontFamily: {
        arenq: ['Arenq'],
        beckman: ['Beckman'],
